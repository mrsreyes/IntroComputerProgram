...
var deleteTask = function() {
	var index = parseInt(prompt("Please enter the index number of the tasks to delete."));	//pg 267
	if (!isNaN(index)) {
        tasks.splice(index, 1); //pg 269
        localStorage.tasks = tasks.join("|");
        displayTaskList();
    }
}

var toggleSort = function() { //pg 269
...
var setName = function() {
    ...
    sessionStorage.setItem("name", name);  //pg 281 saves data in item
    displayTaskList();
}
